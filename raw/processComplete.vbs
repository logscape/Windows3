...
REM		elseif filterProcessName(doNotFilter,procName)	> 0 Then
REM				WSCript.Echo timestamp & sep & host _
REM				& sep & ProcessName.Item(processId) _
REM				& sep & processId & sep & ProcPct _
REM				& sep & MemPct & sep & ProcessPriority.Item(processId) _
REM				& sep & ProcessOwner.Item(processId) _
