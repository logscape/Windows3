 ...
 * [WindowsApp-1.6.zip](https://github.com/logscape/Windows3/blob/master/dist/WindowsApp-1.6.zip?raw=true)	
...
3. Once both are uploaded, press DEPLOY on WindowsApp-1.6.zip (the application, not the override file).
